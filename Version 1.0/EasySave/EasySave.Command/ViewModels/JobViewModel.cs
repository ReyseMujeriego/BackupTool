...
public class JobViewModel
{
    ...
    public void ExecuteJob(int index) => jobManager.ExecuteJob(index);

    /// <summary>
    /// Executes multiple jobs sequentially.
    /// </summary>
    /// <param name="indices">An array of job indices to execute.</param>
    public void ExecuteMultipleJobs(int[] indices) => jobManager.ExecuteJobsSequentially(indices);
    ...
    public string GetTranslation(string key) => LanguageManager.GetString(key);
}